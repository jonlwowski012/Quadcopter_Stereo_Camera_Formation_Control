...
def form_control():
	...
	while(run==True):
		...
		px = .0006
		py = .0006
		slave_vel_x = px*((quad.get_position('q1')[0]/dt)-(quad.get_position('q2')[0]/dt)+quad.get_linear_rate('q1')[0]+(quad.get_projection_calculation('q1',True)[0]/dt)-(quad.get_projection_calculation('q2',False)[0]/dt))
		slave_vel_y = py*((quad.get_position('q1')[1]/dt)-(quad.get_position('q2')[1]/dt)+quad.get_linear_rate('q1')[1]+(quad.get_projection_calculation('q1',True)[1]/dt)-(quad.get_projection_calculation('q2',False)[1]/dt))
		ctrl2.update_target([slave_vel_x,slave_vel_y,2])

		### Slave 2 Controller	
		slave_vel_x2 = px*((quad.get_position('q1')[0]/dt)-(quad.get_position('q3')[0]/dt)+quad.get_linear_rate('q1')[0]+(quad.get_projection_calculation('q1',False)[0]/dt)-(quad.get_projection_calculation('q3',True)[0]/dt))
		slave_vel_y2 = py*((quad.get_position('q1')[1]/dt)-(quad.get_position('q3')[1]/dt)+quad.get_linear_rate('q1')[1]+(quad.get_projection_calculation('q1',False)[1]/dt)-(quad.get_projection_calculation('q3',True)[1]/dt))
...
def Run():
	...
	while(run==True):
		...
		'''with open('/home/ace/catkin_ws/src/Quadcopter_simulator/results/SFB/results.csv', 'a') as fp:
